...
public class HomeRecommendedOppTester extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        device.wait(Until.hasObject(By.text("RECOMMENDED")), 5000);
        UiObject2 homeBanner = device.findObject(By.text("RECOMMENDED"));
        homeBanner.click();
        device.waitForIdle(5000);
        //  UiObject2 resultText = device.findObject(By.clazz("android.widget.EditText"));
        String result = homeBanner.getText();
        assertTrue(result.equals("RECOMMENDED"));
    }
