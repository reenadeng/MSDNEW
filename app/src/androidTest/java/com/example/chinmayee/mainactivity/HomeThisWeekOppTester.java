...
public class HomeThisWeekOppTester extends InstrumentationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        device.wait(Until.hasObject(By.text("THIS WEEK")), 5000);
        UiObject2 homeBanner = device.findObject(By.text("THIS WEEK"));
        homeBanner.click();
