...
public class OtherUserInfoTester extends InstrumentationTestCase {
    ...
    //    UiObject img = device.findObject(new UiSelector().resourceId("com.example.chinmayee.mainactivity:id/imageView1"));
     //   img.click();
