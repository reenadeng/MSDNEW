...
public class MyOpportunitiesCompletedTester extends InstrumentationTestCase {
     ...
     //   Runtime.getRuntime().exec(new String[]{"am", "force-stop", "MSD"});
      ...
      //          .scrollable(true));
       // appViews.swipeLeft(1000);
        ...
        device.wait(Until.hasObject(By.text("COMPLETED ")), 12000);
        UiObject2 opp = device.findObject(By.text("COMPLETED "));
        opp.click();
