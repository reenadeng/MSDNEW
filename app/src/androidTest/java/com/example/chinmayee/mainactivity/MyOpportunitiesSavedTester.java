...
public class MyOpportunitiesSavedTester extends InstrumentationTestCase {
     ...
     //   Runtime.getRuntime().exec(new String[]{"am", "force-stop", "MSD"});
      ...
      //          .scrollable(true));
       // appViews.swipeLeft(1000);
        ...
        device.wait(Until.hasObject(By.text("  SAVED")), 10000);
        UiObject2 opp = device.findObject(By.text("  SAVED"));
        opp.click();
